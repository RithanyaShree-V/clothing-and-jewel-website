      ...
      <div className="auth-container">
        ...
        {noUsersMessage && (
          <div className="info-message">
            No account found. Please <Link to="/signup" className="auth-link">sign up</Link> first to create an account.
          </div>
        )}
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="auth-button" disabled={isSubmitting || noUsersMessage}>
